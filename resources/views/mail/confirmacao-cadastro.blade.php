...
<table bgcolor="#e8e8e8" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
       style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e8e8e8; width: 100%;"
    ...
    <tr style="vertical-align: top;" valign="top">
        <td style="word-break: break-word; vertical-align: top;" valign="top">
            ...
            <tr>
                <td align="center" style="background-color:#e8e8e8"><![endif]-->
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center fullwidth"
                                        ...
                                        {{--url('images/mail/rounder-up.png')--}}
                                        <img align="center" alt="Image" border="0" class="center fullwidth"
                                             src="{{$message->embed(public_path('images/mail/rounder-up.png'))}}"
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center"
                                        ...
                                        <![endif]--><img align="center" alt="Image" border="0" class="center"
                                                         src="{{$message->embed(public_path('images/softbeleza-logo-azul.png'))}}"
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 28px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 34px; margin: 0;">
                                                <span style="font-size: 28px;"><strong><span style="font-size: 28px;">Olá {{$primeiroNome}},</span></strong></span><br/><span
                                                    style="font-size: 28px;">Bem Vindo(a) ao sistema <strong>SoftBeleza!</strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div align="center" class="img-container center">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr style="line-height:0px">
                                            <td style="" align="center"><![endif]-->
                                        <img align="center" alt="Image"
                                             border="0" class="center"
                                             src="{{$message->embed(public_path('images/mail/divider.png'))}}"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                Agradecemos pela sua inscrição no site!<span
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                A partir de hoje você pode acessar ao sistema com todas funcionalidades
                                                disponíveis  economizando horas de trabalho, clicando no botão logo
                                                abaixo.</p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div align="center" class="button-container"
                                        ...
                                        <tr>
                                            <td style="padding-top: 25px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                ...
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                             ...
                                                             style="height:46.5pt; width:192.75pt; v-text-anchor:middle;"
                                                             arcsize="7%" stroke="false" fillcolor="#0068a5">
                                                    <w:anchorlock/>
                                        ...
                                        <![endif]-->
                                        <div
                                            style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0068a5;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #0068a5;border-right:1px solid #0068a5;border-bottom:1px solid #0068a5;border-left:1px solid #0068a5;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all; cursor: pointer">
                                            <span
                                                style="padding-left:15px;padding-right:15px;font-size:16px;display:inline-block;"><a
                                                    href="{{$linkConfirmacaoCadastro}}"
                                                    style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px; text-decoration:none; color: white">CONFIRMAR CADASTRO</a></span>
                                        </div>
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center fullwidth"
                                        ...
                                        <![endif]--><img align="center" alt="Image" border="0" class="center fullwidth"
                                                         src="{{$message->embed(public_path('images/mail/rounder-dwn.png'))}}"
                                                         style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 600px; display: block;"
                                                         title="Image" width="600"/>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
